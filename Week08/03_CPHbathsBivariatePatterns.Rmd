...
# Get data
```{r}
baths_hist <- read_rds("../data/baths_hist.rds") # historical baths
...
Before we try some cross-functions, we need to wrangle the data in shape. 
Specifically, we first need to combine the two baths datasets into a single marked `ppp` object.
