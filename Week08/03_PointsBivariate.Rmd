...
```{r crime-solution, warning=FALSE}
# Load the spatstat package
library(spatstat)
...
# Draw the map with colors, sizes and plot character
preston_map(cols = c("black", "red"),  cex = c(0.5, 1),  pch = c(19,19))
```
...
```{r crime-density-solution, warning=FALSE}
# preston_crime has been pre-defined
preston_crime
...
# You can look at the result by plot(crime_densities)
# Calc the violent density divided by the sum of both
