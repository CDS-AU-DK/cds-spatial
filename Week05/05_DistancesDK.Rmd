...
### Solution
```{r diff-sol, echo = FALSE}
# Calculate the difference in km
(distRhumb(my_points)-distVincentyEllipsoid(my_points))/1000 # 711 km

# Calculate percent difference
(distRhumb(my_points)-distVincentyEllipsoid(my_points))/distVincentyEllipsoid(my_points)*100 # ~4.4%
```
Try out the different methods and check what the metric difference is between the results
...
# difference
euc_dist-geo_dist # ~5880 km
(euc_dist-geo_dist)/geo_dist*100  # 36%
```
...
# Task 4: Least Cost Paths to Viking-era monuments in Aarhus (TBD)
