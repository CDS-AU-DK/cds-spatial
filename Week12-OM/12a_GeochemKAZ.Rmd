...
mapview(kaz_sites) + mapview(kaz_geo, cex = 0.5)
...
ggplot(kaz_geo) +
  ...
  geom_sf(data=kaz_sites, color = "red")
...
ggplot() +
  geom_density(aes(x = pFertile), fill = "skyblue", color = "blue") +
  labs(title = "Kernel Density Estimation (KDE) Plot of Exceedance Probability",
