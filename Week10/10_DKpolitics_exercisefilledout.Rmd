...
In order to show something we need to connect the spatial polygons with some attributes. Let's pick the voting data from Denmark Statistik and calculate the total numbers of party votes in each municipality and calculate the percentages. 
...
plot(DKSD$sum2015, st_area(DKSD , byid = TRUE))
...
?moran.mc()
moran.mc(DF$Y2015, 
           nb2listw(nb, zero.policy=TRUE),zero.policy=TRUE, nsim = 999)
```
