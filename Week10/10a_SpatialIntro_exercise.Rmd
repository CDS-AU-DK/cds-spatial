...
# Task 1: Simple spatial principles: create a uniform point pattern
...
* Run a quadrat test on the `ppois` and compare the results to uniform pattern above. 
...
# Run a quadrat test and look at the results
___
```
