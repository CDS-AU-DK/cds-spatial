...
# reproject
nitrates4326 <- st_transform(nitrates25832, crs = 4326)
elev4326 <- projectRaster(elevation, crs = 4326, method = "ngb")

# plot
plot(elev4326)
plot(nitrates4326$WKT, add= T, cex = 0.1)
plot(places4326, add =T, col = "red")
```
