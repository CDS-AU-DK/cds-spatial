...
df_crs <- ___(df_sf, crs = ___(manhattan, ___ = TRUE))
...
neighborhoods_tf <- ___(neighborhoods, crs = 32618)

# Compute the neighborhood centroids
centroids <- ___(neighborhoods_tf)

# Plot the neighborhood geometry
plot(___(neighborhoods_tf), col = "grey", border = "white")
...
plot(___(neighborhoods), col = "grey", border = "white")
plot(beech, ___ = ___, pch = 16, col = "forestgreen")

# Compute the coordinates of the bounding box
___(beech)

# Create a bounding box polygon
beech_box <- ___(beech, n = ___)

# Plot the neighborhoods, add the beech trees and add the new box
plot(___(neighborhoods), col = "grey", border = "white")
plot(beech, add = ___, pch = 16, col = "forestgreen")
plot(beech_box, add = ___)
```
...
beech_buffers <- ___(beech_buffer)
...
beech_buf_union <- ___(beech_buffers)
