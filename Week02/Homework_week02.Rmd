...
Make a handsome map of Denmark from data available online with a scale, a north arrow and source credits! Project the data to EPSG 32632, the UTM for Denmark.
...
* Make a map with `tmap` library following the Exercise no.1
