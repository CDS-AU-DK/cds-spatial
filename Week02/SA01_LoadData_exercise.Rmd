...
trees <- ___("data/trees.shp")

# Read in the neighborhood shapefile
neighborhoods <- ___(___)
...
Nice work you've learned how to read in single and multi-band rasters. You should have noticed, based on the `nlayers()` function, that the `canopy` object has a single layer and the `manhattan` object has three.
