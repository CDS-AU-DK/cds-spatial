...
parks <- read_sf("../data/playgrounds4326.shp")

# Read in the playgrounds shapefile
playgrounds <- read_sf("../data/parks.shp")
...
*PARKS*: 51 features, POINT
*PLAYGROUNDS*: 47 features, MULTIPOLYGON
*SHELTHERS*: 19 features, POINT

(note for comprehension: features are observations (rows), and fields are variables (columns))

2. What is the CRS value in these objects?
*FORESTS*: (Projected CRS) ETRS89 
*PARKS*: NA
*PLAYGROUNDS*: (Projected CRS) ETRS89
