...
This script uses the `leaflet` library to visualize the spatial component of the data accompanying the Spring 2021 course on the City: Between Culture and Nature, taught by Mikkel Thelle and Mikkel Høghøj. 
...
See if you can plot the provided data and differentiate by color the baths whose location is known with certainty (Quality = 1) and where it is guesstimated (Quality = 2)
