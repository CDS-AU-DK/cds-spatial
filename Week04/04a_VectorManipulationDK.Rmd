---
title: "Week 04a - Bounding boxes, Buffers, and Centroids"
...
municipalities_25832 <- ___(__________(municipalities), crs = _______)
...
# Convert municipalities to sf object and project to epsg 25832
municipalities_25832 <- st_transform(st_as_sf(municipalities), crs = 25832)
...
# plot shelters in aarhus kommune
all.equal(crs(aarhus_mun), crs(shelters))

plot(st_geometry(aarhus_mun), col = "grey") 
plot(shelters$geometry, add = T, pch = 16, col = "forestgreen")
```
...
# Confirm that we went from 7 features to 1 feature
length(shelters)
length(sh1)
