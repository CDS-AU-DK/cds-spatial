---
title: "Week 04 - Network Travel and Accessibility"
...
```
```{r opencage-auth-sol, echo = FALSE}
library(opencage)
library(tidyverse)
...
# set key in the environment
Sys.setenv(OPENCAGE_KEY = "9ad09524776340b9bf3f97840b0198dc")
...
* It would be nice to limit the results to Midtjylland region only :)
...
*3. Are there any areas that are located beyond a 20-minute bikeride of a hospital that have proportionally lower access to cars? Where are they and what is their total area?*
